...
public class TestCases2 extends SalesForceProjectBase {
	...
	public void RunSalesForceTestCase1() throws InterruptedException, AWTException {
	    ...
	    driver.findElement(By.xpath("//label/span[text()='Status']/following::button[1]")).click();
		//WebElement StatusDropdown=driver.findElement(By.xpath("//lightning-base-combobox[@class='slds-combobox_container']"));
		...
		//((JavascriptExecutor) driver).executeScript("arguments[0].click();", StatusDropdown1);*/
